...
public class ServerInstance {
	...
	private IPath getXMLContextFilePath(String path){
		...
		//Save it as file in the WTP /wtpwebappx
		String fileName = pathWithoutSlash + ".xml";
		IPath contextFolderPath = _runtimeBaseDirectory.append("wtpwebapps");
	...
	private WebAppContext createContext(InputStream stream) throws IOException, SAXException {
		...
		webAppContextFactory.setPackageName("org.eclipse.jst.server.jetty.core.internal.xml.jetty9.webapp");
	...
	private void loadContextsIfNeeded(){
		if (_contextsLoaded){
			...
			try{
				...
				IPath contexts = _runtimeBaseDirectory.append("wtpwebapps");
